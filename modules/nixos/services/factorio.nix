...
let
  ...
  factorioVersions =
    let
      dist = {
        name = "factorio_headless_x64-2.1.7.tar.xz";
        version = "2.1.7";
        tarDirectory = "x64";
        url = "https://factorio.com/get-download/2.1.7/headless/linux64";
        sha256 = "2a8d66db3566a2ed54787031f68103cad19ab480b41a7042310ccbd52c0ffbc4";
        needsAuth = false;
      };
    in
    {
